            ...
            <div className="grid md:grid-cols-2">
              <div className="relative px-8 self-center xl:mb-32">
                ...
                <ul className="mt-16 mb-20">
                  <li style={{color: '#fff', fontSize: '16px'}} className="flex items-center mb-4 text-gray-600 text-xl 2xl:text-4xl font-display font-normal leading-normal">
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12 animated">
            <div className="grid md:grid-cols-2 md:grid-cols-8 gap-24">
              <div className="flex flex-col px-8 md:col-span-3 col-span-6 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-300 mt-12 text-xl font-display animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">Maintaining your anonymity with fun pseudo-username randomly generated for new accounts. The pseudo-name serves as your default username for perfect anonymity. PseudoUsername are designed randomly in [Adj. + Adj. + Animal Name]&nbsp; format.
                </p>
                <a style={{padding: '1rem 3rem', marginTop: '20px', fontSize: '16px'}} href="https://our.pcnp.io/usernames-in-the-status-messenger/" className="btn  btn-gradient-purple btn-glow mr-4 mb-2 animated fadeInUpShorter" data-animation="fadeInUpShorter" data-animation-delay="1.7s">Learn More about PCNP Usernames</a>
              </div>
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              ...
              <div className="flex order-first md:order-last flex-col px-8 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-600 mt-12 text-xl font-display animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">Private keys will be provided that are dedicated for access to chats and wallets exclusively generated for you. The private keys will be generated by BIP43 via a path derived from the BIP39 mnemonic phrase</p>
                <div className="flex">
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-600 mt-12 text-xl font-display animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">By staking your 10 PCNP tokens you can register on ENS with a state of us. eth text-based-username in your profile tab. PCNP allows you to register with Ethereum Name Service (ENS) with your wallet address and associate with a custom text username reducing its anonymity.&nbsp;
                </p>
                <div className="flex">
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-8 gap-24">
              <div className="flex flex-col px-8 col-span-6 md:col-span-3 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-600 mt-12 text-xl font-display animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">PCNP never leaves a minute loophole leading to a vulnerability in user’s privacy therefore experts introduced KeyCard. The keyCard is an extended hardware technology of a user's PCNP account. With KeyCard, PCNP users can get offline access to the account with just one tap of the card and pin.
                </p>
                <div className="flex">

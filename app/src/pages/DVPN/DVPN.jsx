                    ...
                    <div className="max-w-screen-2xl mx-auto lg:px-12">
                      <div className="grid md:grid-cols-2 ">
                        <div style={{marginBottom: '1rem'}} className="relative px-8 self-center xl:mb-32">
                          ...
                          <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-600 mt-10 mb-16 text-xl 2xl:text-4xl font-display font-normal leading-normal">
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className=" mt-6 text-xl font-display leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">Stake your PCNP tokens to earn rewards from mining, selling, or sharing your extra bandwidth and also get paid to watch ads. PCNP aims to introduce a more democratic, user-friendly, and economically sustainable dVPN</p>
              </div>
              <div className="px-8 mb-24 md:mb-0">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className=" mt-6 text-xl font-display leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">With dVPN let you use the regionally blocked sites and social media apps with zero hassle. Experience the freedom to use the latest browser where you watch ads if you want and earn more PCNP tokens</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <ul className="grid md:grid-cols-3 mt-16 gap-24">
              <li className="text-gray-200 text-2xl xl:text-5xl flex items-start">
                ...
                <div className="ml-8">
                  ...
                  <p style={{color: '#fff', fontSize: '15px'}} className="text-gray-900 text-xl animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">Secure the integrity of PCNP’s open-source dVPN by staking your PCNP Tokens and earning rewards in crypto tokens by becoming a bandwidth miner.&nbsp;&nbsp;
                  </p>
                </div>
              </li>
              <li className="text-gray-200 text-2xl xl:text-5xl flex items-start">
                ...
                <div className="ml-8">
                  ...
                  <p style={{color: '#fff', fontSize: '15px'}} className="text-gray-900 text-xl animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">Pay for the bandwidth you use only and share the left-over by selling the leftover bandwidth and earn in crypto tokens.&nbsp;&nbsp;</p>
                </div>
              </li>
              <li className="text-gray-200 text-2xl xl:text-5xl flex items-start">
                <MessengerBenefit3 />
                <div className="ml-8">
                  ...
                  <p style={{color: '#fff', fontSize: '15px'}} className="text-gray-900 text-xl animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">Set up a node and connect with dVPN anywhere anytime. Users can connect without worrying about being scanned, tracked, blocked, or attacked by any third party.</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-300 mt-12 text-xl font-display  leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">User’s demand for dVPN to attain complete autonomy over any online information, no online surveillance tracking activities and geo-positioning, no personal data shared with shopping sites or any third party.</p>
                <div className="flex">
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-600 mt-12 mb-20 text-xl font-display  leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">With dVPN the power is back to the PCNP’s users, you have the authority to choose whether to watch advertisements or not, also getting 70% of the revenue from ads rewarded as PCNP tokens.</p>
              </div>
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pb-32 md:pb-0">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-600 mt-12 text-xl font-display leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">The majority of the users use dVPN to maintain privacy by remaining anonymous about their online activities while browsing, shopping, or transacting funds online via Web 3.0. PCNP makes sure to fulfill dVPN’s purpose to attain users’ trust and need to browse &amp; scroll online with any surveillance.
                </p>

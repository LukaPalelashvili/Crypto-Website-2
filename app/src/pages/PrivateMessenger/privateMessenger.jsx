              ...
              <div className="max-w-screen-2xl mx-auto lg:px-12">
                <div className="grid md:grid-cols-2">
                  <div style={{marginBottom: '1rem'}} className="relative px-8 self-center xl:mb-32">
                    ...
                    <p style={{fontSize: '18px', color: '#fff'}} className="text-gray-600 mt-10 mb-16 text-xl 2xl:text-4xl font-display font-normal leading-normal">
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              ...
              <div className="flex flex-col px-8 order-second md:order-last justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-300 mt-6 text-xl font-display  leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className=" mt-6 text-xl font-display leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">Unlock the opportunity to earn PNCP tokens by creating &amp; sending your own stickers in the Decentralized NFT marketplace</p>
              </div>
              <div className="px-8 mb-24 md:mb-0">
                <div className="mx-auto flex justify-center items-center md:block pb-16 md:pt-48">
                </div>
                <h3 style={{color: '#fff', fontSize: '32px'}} className="font-display text-4xl xl:text-5xl 2xl:text-6xl animated" data-animation="fadeInUpShorter" data-animation-delay="0.2s">Hassle-Free Payments via Crypto Wallets</h3>
                <p style={{color: '#fff', fontSize: '16px'}} className=" mt-6 text-xl font-display leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">PCNP’s privacy-driven messenger lets its privileged users gain accessibility over direct global payments in chats using our integrated Crypto-Wallet.&nbsp;</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-screen-2xl mx-auto px-8 lg:px-20">
            ...
            <ul className="grid md:grid-cols-3 mt-16 gap-24">
              <li className="text-gray-200 text-2xl xl:text-5xl flex items-start">
                <MessengerBenefit1 />
                <div className="ml-8">
                  <h4 style={{color: '#fff', fontSize: '24px'}} className="mb-12 text-2xl xl:text-4xl font-display text-gray-900 animated" data-animation="fadeInUpShorter" data-animation-delay="0.2s">Anonymous Account Generation&nbsp;</h4>
                  <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-900 text-xl animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">Users are not requested to submit personal details including smartphone contact numbers, email address or bank accounts to create a PCNP account.&nbsp;&nbsp;
                  </p>
                </div>
              </li>
              <li className="text-gray-200 text-2xl xl:text-5xl flex items-start">
              <MessengerBenefit2 />
                <div className="ml-8">
                  <h4 style={{color: '#fff', fontSize: '24px'}} className="mb-12 text-2xl xl:text-4xl font-display text-gray-900 animated" data-animation="fadeInUpShorter" data-animation-delay="0.2s">Zero-Censorship&nbsp;</h4>
                  <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-900 text-xl animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">No more censoring from any third party as PCNP removes all the third-party choke points.&nbsp;</p>
                </div>
              </li>
              <li className="text-gray-200 text-2xl xl:text-5xl flex items-start">
              <MessengerBenefit3 />
                <div className="ml-8">
                  <h4 style={{color: '#fff', fontSize: '24px'}} className="mb-12 text-2xl xl:text-4xl font-display text-gray-900 animated" data-animation="fadeInUpShorter" data-animation-delay="0.2s">Open - Source with No Installation Fee</h4>
                  <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-900 text-xl animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">&nbsp;PCNP is open-source software that can be reviewed by anyone and is free to install by anyone anywhere.
                  </p>
                </div>
              </li>
            </ul>
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff', fontSize: '16px'}} className="text-gray-300 mt-12 text-xl font-display  leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">With PCNP, you can have peer-to-peer chats without worrying about third-party interference or surveillance. PCNP messaging has removed all centralized choke points to lever up the privacy of the P2P network.</p>
                <div className="flex">
          ...
          <div className="max-w-screen-2xl mx-auto lg:px-12">
            <div className="grid md:grid-cols-2 gap-24">
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pt-32">
                ...
                <p style={{color: '#fff',  fontSize: '16px'}} className="text-gray-600 mt-12 mb-20 text-xl font-display  leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">PCNP direct messaging works using end-to-end encryption that provides accessibility to private chats to you and your recipient only.&nbsp;</p>
              </div>
              <div className="flex flex-col px-8 justify-center items-start md:pt-0 pb-32 md:pb-0">
                ...
                <p style={{color: '#fff',  fontSize: '16px'}} className="text-gray-600 mt-12 text-xl font-display leading-normal animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">PCNP messaging is designed to maintain maximum text privacy even if somehow compromised. Modified Version of double ratchet algorithm that stops access to previous and future encrypted texts.&nbsp;
                </p>

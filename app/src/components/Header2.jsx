...
export const header2 = () => {
    return (
        ...
        <nav className="main-menu static-top navbar-dark navbar navbar-expand-lg mb-1 navbar-absolute"><div className="container">
            <a className="navbar-brand" href="#head-area"><img style={{width: '160px', height: '60px'}} src={LogoTransparent} alt="Pcnprotocol Logo" /></a>

...
!function () {
    var e, t, o, n = {
            ...
            fixedBackground: !0,
            excluded: ""
        }, r = n, a = !1, i = !1, l = {x: 0, y: 0}, c = !1, u = document.documentElement, d = [],
    ...
    function w() {
        if (!c && document.body) {
            c = !0;
            var n = document.body, l = document.documentElement, d = window.innerHeight, s = n.scrollHeight;
            if (u = document.compatMode.indexOf("CSS") >= 0 ? l : n, e = n, r.keyboardSupport && X("keydown", g), top != self) i = !0; else if (J && s > d && (n.offsetHeight <= d || l.offsetHeight <= d)) {
                var f, m = document.createElement("div");
                m.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + u.scrollHeight + "px", document.body.appendChild(m), o = function () {
                    f || (f = setTimeout(function () {
                        a || (m.style.height = "0", m.style.height = u.scrollHeight + "px", f = null)
                    }, 500))
                }, setTimeout(o, 10), X("resize", o);
    ...
    var h = [], p = !1, v = Date.now();

    function y(e, t, o) {
        var n, a;
        if (a = o, n = (n = t) > 0 ? 1 : -1, a = a > 0 ? 1 : -1, (l.x !== n || l.y !== a) && (l.x = n, l.y = a, h = [], v = 0), 1 != r.accelerationMax) {
            var i = Date.now() - v;
        ...
        if (h.push({x: t, y: o, lastX: t < 0 ? .99 : -.99, lastY: o < 0 ? .99 : -.99, start: Date.now()}), !p) {
            var u = e === document.body, d = function (n) {
                for (var a = Date.now(), i = 0, l = 0, c = 0; c < h.length; c++) {
                    var s = h[c], f = a - s.start, m = f >= r.animationTime, w = m ? 1 : f / r.animationTime;
                    r.pulseAlgorithm && (w = V(w));
                    var v = s.x * w - s.lastX >> 0, y = s.y * w - s.lastY >> 0;
    ...
    function b(t) {
        ...
        var n = -t.wheelDeltaX || t.deltaX || 0, a = -t.wheelDeltaY || t.deltaY || 0;
        s && (t.wheelDeltaX && B(t.wheelDeltaX, 120) && (n = t.wheelDeltaX / Math.abs(t.wheelDeltaX) * -120), t.wheelDeltaY && B(t.wheelDeltaY, 120) && (a = t.wheelDeltaY / Math.abs(t.wheelDeltaY) * -120)), n || a || (a = -t.wheelDelta || 0), 1 === t.deltaMode && (n *= 40, a *= 40);
        var l = H(o);
        return l ? !!function (e) {
            if (!e) return;
            d.length || (d = [e, e, e]);
            return e = Math.abs(e), d.push(e), d.shift(), clearTimeout(D), D = setTimeout(function () {
                try {
                    localStorage.SS_deltaBuffer = d.join(",")
                } catch (e) {
                }
            }, 1e3), !N(120) && !N(100)
        }(a) || (Math.abs(n) > 1.2 && (n *= r.stepSize / 120), Math.abs(a) > 1.2 && (a *= r.stepSize / 120), y(l, n, a), t.preventDefault(), void E()) : !i || !W || (Object.defineProperty(t, "target", {value: window.frameElement}), parent.wheel(t))
    }

    function g(t) {
        var o = t.target, n = t.ctrlKey || t.altKey || t.metaKey || t.shiftKey && t.keyCode !== f.spacebar;
        document.body.contains(e) || (e = document.activeElement);
        var a = /^(button|submit|radio|checkbox|file|color|image)$/i;
        if (t.defaultPrevented || /^(textarea|select|embed|object)$/i.test(o.nodeName) || A(o, "input") && !a.test(o.type) || A(e, "video") || function (e) {
            var t = e.target, o = !1;
    ...
    var K,
        P = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function (e, t, o) {
            window.setTimeout(e, o || 1e3 / 60)
        }, R = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, j = function () {
            if (!K) {
    ...
    var F, I = window.navigator.userAgent, _ = /Edge/.test(I), W = /chrome/i.test(I) && !_, $ = /safari/i.test(I) && !_,
        U = /mobile/i.test(I), G = /Windows NT 6.1/i.test(I) && /rv:11/i.test(I),
        J = $ && (/Version\/8/i.test(I) || /Version\/9/i.test(I)), Q = (W || $ || G) && !U;

    function Z(e) {
        for (var t in e) n.hasOwnProperty(t) && (r[t] = e[t])
    }

    "onwheel" in document.createElement("div") ? F = "wheel" : "onmousewheel" in document.createElement("div") && (F = "mousewheel"), F && Q && (X(F, b), X("mousedown", S), X("load", w)), Z.destroy = function () {
...
!function (t) {
    ...
    t.cleanData = function (e) {
        ...
        }), r.prototype = t.widget.extend(a, {widgetEventPrefix: o ? a.widgetEventPrefix || e : e}, h, {
            constructor: r,
            namespace: d,
            widgetName: e,
            widgetFullName: n
        ...
        t.Widget.prototype["_" + e] = function (i, n, o) {
            ...
            n = n || {}, "number" == typeof n && (n = {duration: n}), r = !t.isEmptyObject(n), n.complete = o, n.delay && i.delay(n.delay), r && t.effects && t.effects.effect[a] ? i[e](n) : a !== e && i[a] ? i[a](n.duration, n.easing, o) : i.queue(function (s) {
    ...
    t.widget("aerolab.midnight", {
        ...
        _setupHeaders: function () {
            ...
            for (var s = 0; s < this._$sections.length; s++) {
                var i = t(this._$sections[s]), n = i.data(this.options.sectionSelector);
